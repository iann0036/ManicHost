...
*/
define('MAIL_USERNAME', 'admin@iann0036.adm');

/** 
* Your company level password
*/
define('MAIL_PASSWORD', 'SNIPPED');
...
*/
define('APP_MAIL_USERNAME', 'admin');

/** 
* OpenSRS APP Password
*/
define('APP_MAIL_PASSWORD', 'SNIPPED');

/** 
* OpenSRS APP domain
*/
define('APP_MAIL_DOMAIN', 'iann0036.adm');
